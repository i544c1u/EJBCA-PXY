...
curl POST https://localhost:8000/v1/certificate/certificaterequest \
...
curl POST https://localhost:8000/v1/certificate/search \
  -H "Content-Type: application/json" \
  -d '{
        "query": {
            "username": "jdoe",
...
# v1/endentity
curl POST https://localhost:8000/v1/endentity \
  -H "Content-Type: application/json" \
  -d '{
        "username": "jdoe",
        "password": "SecretPass123",
